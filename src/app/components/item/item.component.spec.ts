...
describe('ItemComponent', () => {
  ...
  it('should have a button', () => {
    const button: DebugElement = fixture.debugElement.query(By.css('input[type=button][value=Del]'));
  ...
  it('should trigger delete', (done) => {
    component.todo = {name: 'Hausaufgabe', status: TodoStatus.Open, id: 123321};
